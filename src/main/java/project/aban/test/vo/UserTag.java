...
public class UserTag {
	...
	public UserTag(String id, int q1, int q2, int q3, int q4, int q5, int q6, int q7, int q8, int q9, int q10, int q11,
			int q12, int q13) {
		super();
		this.id = id;
		this.q1 = q1;
	...
	public String toString() {
		return "UserTag [id=" + id + ", q1=" + q1 + ", q2=" + q2 + ", q3=" + q3 + ", q4=" + q4 + ", q5=" + q5 + ", q6="
