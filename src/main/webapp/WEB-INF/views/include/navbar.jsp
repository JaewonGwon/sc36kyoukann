...
<div class="container">
	<div class="navbar-translate">
		...
		<c:if test="${sessionScope.loginId != null}">
			<a class="navbar-brand text-warning" rel="tooltip"
				data-placement="bottom"> <i class="now-ui-icons users_circle-08"></i>
	...
	<div class="collapse navbar-collapse justify-content-end"
		...
		<ul class="navbar-nav">
			...
			<li class="nav-item dropdown"><a href="#"
				...
				data-toggle="dropdown"> <i class="now-ui-icons ui-2_chat-round"></i>
					<p>도서 리뷰</p>
			</a>
 ...
 --> <a class="nav-link"
				...
				target="_blank"> <i
					class="now-ui-icons education_agenda-bookmark"></i>
					<p>내 서재</p>
			</a>
			</li>
			<c:if test="${sessionScope.loginId == null}">
				<li class="nav-item"><a class="nav-link btn btn-warning"
					href="login"> <i class="now-ui-icons gestures_tap-01"></i>
						<p>로그인</p>
				</a></li>
			</c:if>
			...
			<li class="nav-item"><a class="nav-link" rel="tooltip"
				title="Follow us on Twitter" data-placement="bottom" href="#"
				target="_blank"> <i class="fab fa-twitter"></i>
					<p class="d-lg-none d-xl-none">Twitter</p>
			</a></li>
			<li class="nav-item"><a class="nav-link" rel="tooltip"
				title="Like us on Facebook" data-placement="bottom" href="#"
